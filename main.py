...
def build(req: BuildRequest):
    ...
    """
    logger.info(f"Build requested: repo={req.repo_url} branch={req.branch} function_name={req.function_name}")
    try:
        result = build_and_push(req.repo_url, req.branch, req.function_name, req.subdir)
